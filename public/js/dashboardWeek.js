$(document).ready(function() {
    $.getJSON('../api/summary/daily',{"pastDays":"7"})
    .done(function(data){
        ...
        $("#distWalk").text( ((distWalk-10000)/1610).toFixed(2) + " mi");
        $("#distRun").text( ((distRun-10000)/1610).toFixed(2) + " mi");
        $("#distCycle").text( ((distCycle-10000)/1610).toFixed(2) + " mi");
